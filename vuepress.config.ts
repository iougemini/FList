...
export default defineUserConfig({
  ...
  head: [['link', { rel: 'icon', href: 'https://img.everyhub.top/i/2025/142b780bca129dd0.png' }]],
  ...
  theme: FileList([
    ...
    },
    {
      // 挂载路径
      mountPath: "/Sing-box",
      // 文件解析器，这里使用githubReleasesFilesAnalysis,可以解析github的release文件,https://github.com/SagerNet/sing-box
      analysis: githubReleasesFilesAnalysis({
        // 仓库所有者的用户名
        user: "SagerNet",
        // 仓库所有者的仓库名
    ...
    },
    {
      // 挂载路径
      mountPath: "/Nekoray",
      // 文件解析器，这里使用githubReleasesFilesAnalysis,可以解析github的release文件,https://github.com/MatsuriDayo/nekoray/releases
      analysis: githubReleasesFilesAnalysis({
        // 仓库所有者的用户名
        user: "MatsuriDayo",
        // 仓库所有者的仓库名
    ...
    {
      // 挂载路径
      mountPath: "/V2ray-core",
      // 文件解析器，这里使用githubReleasesFilesAnalysis,可以解析github的release文件,https://github.com/v2fly/v2ray-core
      analysis: githubReleasesFilesAnalysis({
        // 仓库所有者的用户名
        user: "v2fly",
        // 仓库所有者的仓库名
    ...
    {
      // 挂载路径
      mountPath: "/Naiveproxy",
      // 文件解析器，这里使用githubReleasesFilesAnalysis,可以解析github的release文件,https://github.com/apernet/hysteria/releases
      analysis: githubReleasesFilesAnalysis({
        // 仓库所有者的用户名
        user: "klzgrad",
        // 仓库所有者的仓库名
        repository: "naiveproxy",
        // github 授权 Token, process.env.xxx  xxx 是环境变量名称。可以通过设置 githubToken 环境变量来配置
        authorizationToken: process.env.githubToken,
        // 分页大小，不懂得话就当作取最新的多少个标签吧。
        per_page: 10,
    ...
    },	
    {
      ...
      analysis: fileUrlTreeAnalysis({
        "/.NET 6.0 Desktop Runtime/v6.0.33.exe": "https://download.visualstudio.microsoft.com/download/pr/3ebc1f91-a5ba-477e-9353-198fa4e13371/35f447d6820b078fd18523764a4f0213/windowsdesktop-runtime-6.0.33-win-x64.exe",
        "/.NET 8.0 Desktop Runtime/v8.0.8.exe": "https://download.visualstudio.microsoft.com/download/pr/907765b0-2bf8-494e-93aa-5ef9553c5d68/a9308dc010617e6716c0e6abd53b05ce/windowsdesktop-runtime-8.0.8-win-x64.exe"
